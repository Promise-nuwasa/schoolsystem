...
class Trainer(models.Model):
    ...
    trainer_Id=models.TextField(max_length=20,null='true',blank="true")
    lessons_attended=models.PositiveSmallIntegerField(null='true',blank="true")
    bank_account=models.TextField(max_length=30,null='true',blank="true")
    contract=models.TextField(max_length=30,null='true',blank="true")
